...
export default function MainVisual({widget}) {
  ...
  const Items = [
    { src: './../images/template/T0003/main/m_visual.png', alt: '비주얼이미지1', id: 1 },
    { src: './../images/template/T0003/main/m_visual.png', alt: '비주얼이미지2', id: 2 },
    { src: './../images/template/T0003/main/m_visual.png', alt: '비주얼이미지3', id: 3 }
  ];
